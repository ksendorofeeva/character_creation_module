...
def attack(char_name: str, char_class: str) -> str:
    """Функция attack считает мощность атаки каждого персонажа."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} не применял специальные умения')


def defence(char_name: str, char_class: str) -> str:
    """Функция defence считает отражение атаки."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция special считает применение специальнх умений."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не применял специальное умение')


def start_training(char_name: str, char_class: str) -> str:
    """Функция start_training представляет персонажей."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция choice_char_class приветствует игрока, выбирает персонажа."""
    approve_choice = str
    char_class = str
